...
<head>
  ...
  <title>E Tutory.lk | Exams & Courses</title>
    ...
    <div class="container container-mainnav d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="{{url('/courses')}}">Buy Model Exams</a></li>
  ...
  <section id="about" class="about">
    <div class="container">
      ...
      <div class="section-title">
        <h2>Exams</h2>
        <h3>Exams <span>We Offer</span></h3>
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" action="{{url('/searchexamshome') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}

                <div class="row">
                  <div class="col">
                    <label for="inputEmail4" class="form-label">Exam Name</label>
                    <input type="text" class="form-control" name ="examname" placeholder="Exam Name" aria-label="First name">
                  </div>
                  <div class="col">
                    <label for="inputEmail4" class="form-label">Grade</label>

                    <select class="form-control selectpicker2" name ="grade"  >
                  ...
                  <div class="col">
                    ...
                    <select class="form-control selectpicker2" name ="subject"  >
                      <option value="all">All</option>
                ...
                <button type="submit" class="btn btn-dark mt-3">Search Exams</button>
              </form>
    ...
    <div class="container">
      <div class="row">
        ...
        @foreach($dataset['examsdata']->all() as $exam)
          ...
          <a href="{{url('/loginpage')}}">
            <div class="info-box bg-warning">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Subject : {{$exam->subjectname}}</span>

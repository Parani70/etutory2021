...
<head>
  ...
  <title>E Tutory.lk System | Registration Succesfull</title>
      ...
      <div class="container" style="margin-top: 40px;">
        ...
        <div class="row content">
          ...
          <div class="col-lg-12 pt-4 pt-lg-0">
            <p>
              The link is invalid for the activation!
            </p>
            <p>
              
            </p>
            <a href="{{url('/')}}" class="btn-learn-more">Home</a>
          </div>
        </div>

...
<head>
  ...
  <title>E Tutory.lk | E Learnig Centre | Promotion Payments Receipt</title>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  Successful card payment.
                      ...
                      <p>Congratulations! </p>
                      @endif
                      <p>You have successfully reserved Following Promotion/Packages:</p>
                    </div>
                  </div>
                  <dl class="row">
                    <dt class="col-sm-4">Service Purchased</dt>
                    <dd class="col-sm-8">{{$dataset['promotionName'].' | '.$dataset['promotionSubject'].' for '.$dataset['promotionGrade']}}</dd>
                    
                    <dt class="col-sm-4">Paid Amount</dt>
                    <dd class="col-sm-8">{{number_format($dataset['promotionPrice'],2)}}</dd>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <form role="form" action="{{url('/emailreceipt') }}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input type="hidden" id="examname" value="{{$dataset['promotionID']}}" name="examname">
                        <input type="hidden" id="subject" value="{{$dataset['promotionSubject']}}" name="subject">
                        <input type="hidden" id="grade" value="{{$dataset['promotionGrade']}}" name="grade">
                        <input type="hidden" id="price" value="{{$dataset['promotionPrice']}}" name="price">

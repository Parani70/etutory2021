...
<head>
  ...
  <title>E Tutory.lk | Enter Matching Question</title>
            ...
            <div class="col-md-12">
              <div class="card card-default">
                <div class="card-header">
                  <h3 class="card-title">Matching Question</h3>
                ...
                <form role="form" action="{{url('/savematchingquestion') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="trueflase-anser-block">
                      <div class="row">
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="text-right">Q 1</label>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="mainq1" placeholder="Enter Question 1">
                            @error('mainq1')
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="counterq1" placeholder="Enter Counter Question 1">
                            @error('counterq1')
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <select class="form-control select2 matchingselect" name="matchingq1" style="width: 100%;">
                      ...
                      <div class="row">
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="text-right">Q 2</label>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="mainq2" placeholder="Enter Question 2">
                            @error('mainq2')
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="counterq2" placeholder="Enter Couner Question 2">
                            @error('counterq2')
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <select class="form-control select2 matchingselect" name="matchingq2" style="width: 100%;">
                              <option value="Q1">Q1</option>
                              <option value="Q2">Q2</option>
                              <option value="Q3">Q3</option>
                              <option value="Q4">Q4</option>
                      ...
                      <div class="row">
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="text-right">Q 3</label>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="mainq3" placeholder="Enter Question 3">
                            @error('mainq3')
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="counterq3" placeholder="Enter Couner Question 3">
                            @error('counterq3')
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <select class="form-control select2 matchingselect" name="matchingq3" style="width: 100%;">
                              <option value="Q1">Q1</option>
                              <option value="Q2">Q2</option>
                              <option value="Q3">Q3</option>
                              <option value="Q4">Q4</option>
                      ...
                      <div class="row">
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="text-right">Q 4</label>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="mainq4" placeholder="Enter Question 4">
                            @error('mainq4')
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="counterq4" placeholder="Enter Couner Question 4">
                            @error('counterq4')
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <select class="form-control select2 matchingselect" name="matchingq4" style="width: 100%;">
                              <option value="Q1">Q1</option>
                              <option value="Q2">Q2</option>
                              <option value="Q3">Q3</option>
                              <option value="Q4">Q4</option>
                      ...
                      <div class="row">
                        <div class="col-md-1">
                          <div class="form-group">
                            <label class="text-right">Q 5</label>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="mainq5" placeholder="Enter Question 5">
                            @error('mainq5')
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            <input type="text" class="form-control" name="counterq5" placeholder="Enter Couner Question 5">
                            @error('counterq5')
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <select class="form-control select2 matchingselect" name="matchingq5" style="width: 100%;">
                              <option value="Q1">Q1</option>
                              <option value="Q2">Q2</option>
                              <option value="Q3">Q3</option>
                              <option value="Q4">Q4</option>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{url('/entermatchingquestion')}}" class="btn btn-secondary ">Clear</a>

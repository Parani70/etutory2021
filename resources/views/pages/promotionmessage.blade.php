...
<head>
  ...
  <title>E Tutory.lk | E Learnig Centre | Promotion Issue</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Promotion Error</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="alert alert-info alert-dismissible">
                  ...
                  Your selected subject does not have enough papers to continue. Please check with etutory.lk team!
                </div>
            </div>

...
<head>
  ...
  <title>E Tutory.lk| Levels</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addlevel')}}" class="col-sm-3 btn btn-block btn-primary">Add Level</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <table id="master-datatable" class="table table-bordered">
                    ...
                    <tbody>
                      @if(count($dataset) > 0 )
                      @foreach($dataset['levelsdata']->all() as $level)
                        <tr>
                          <td>{{$level->id}}</td>
                          <td>{{$level->level}}</td>
                          <td>
                          ...
                          <td>
                          <a href="{{url('/managelevel/'.$level->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif

        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <h5>Paper Correction Queu</h5>
                  @if($dataset['datacheck'] == 1)
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      @if(count($dataset['questionsData'] )> 0)
                      @php
                      $i=1;
                      @endphp
                      @foreach($dataset['questionsData']->all() as $qsentry)

                      <tr>
                        <td>{{$i}}</td>
                          @php 
                            $qsdata = DB::table('questionsmain')->where('id', '=', $qsentry->questionid)->get();

                          @endphp
                        <td>{{$qsdata[0]->examtypename}}</td>
                        <td>{{$qsdata[0]->subjectname}}</td>
                        <td>{{$qsdata[0]->gradename}}</td>

                        <td><a href="{{url('/openpapercorrection/'.$qsentry->examseatid.'-'.$qsentry->questionid)}}" class="btn btn-block btn-secondary btn-sm">Open</a></td>
                      </tr>
                  ...
                  <h5><i class="icon fas fa-exclamation-triangle"></i> No Paper Data!</h5>
                 No questions data available for the logged in user.
                </div>
                  @endif

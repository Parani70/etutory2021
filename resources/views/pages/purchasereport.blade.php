...
<head>
  ...
  <title>E Tutory.lk | Purchase Report</title>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{url('/genpurchasereport') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="student" id="student" class="form-control select2" style="width: 100%;">
                      <option value="All">All</option>
                        @if(count($dataset['studentsData']) >0)

                        @foreach($dataset['studentsData']->all() as $student)

                        <option value="{{  $student->id.' - '.$student->studentname}}">{{$student->studentname}}</option>

...
<head>
  ...
  <title>E Tutory.lk | Grades</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addgrade')}}" class="col-sm-3 btn btn-block btn-primary">Add Grade</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <tbody>
                      ...
                      @foreach($dataset['gradesdata']->all() as $grade)
                        <tr>
                          ...
                          <td>
                            <a href="{{url('/managegrade/'.$grade->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif

...
<head>
  ...
  <title>E Tutory.lk | Enter Essay Question</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="col-md-12">
              <div class="card card-default">
                <div class="card-header">
                  <h3 class="card-title">Essay</h3>


                </div>
                <!-- /.card-header -->
                <form role="form" action="{{url('/saveessayquestion') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <textarea class="form-control textarea2" rows="3" name="questionheader" placeholder="Enter Question"></textarea>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="questionimage" style="height:100%;" id="customFile">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          <label>Correction Guidlines</label>
                          <textarea class="form-control textarea" rows="3" name="answerguid" placeholder="Enter Correction Guidlines"></textarea>

                          <input type="hidden" id="essayentryidval" value="{{ Cookie::get('essayentryid') }}" name="essayentryidval">
                          <input type="hidden" id="penentries" value="0" name="penentries">
                          <a href="{{url('/guidlinecanvas/'.Cookie::get('essayentryid'))}}" class="btn btn-danger" id="pen" target="_blank">Pen</a>
                          @error('answerguid')
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <label>Upload Image</label>
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="answerguidimage" style="height:100%;" id="customFile">
                            <label class="custom-file-label" for="customFile">Choose file</label>
                          </div>
                        </div>
                        <div class="form-group">
                          <label>Image Position</label>
                          <select class="col-6 form-control select2" name="imagepositionanswer" id="imageposition" style="width: 100%;">
                            <option value='after'>After Text</option>
                            <option value='before'>Before Text</option>
                          </select>
                        </div>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{url('/enteressayquestion')}}" class="btn btn-secondary ">Clear</a>
  ...
  <script>
    ...
    $('.content-wrapper').hover(function() {
      var thistocken = $('#essayentryidval').val();

      $.get('/readessaycookies/' + thistocken, function(response) {

        if (response.length > 0) {
          console.log(response);
          var value1 = response[0];
          console.log(value1);
          var mytoken = value1['myvalue'];
          var realmytoken = value1['tokenid'];
          console.log(mytoken);
          if (mytoken > 0) {
            $('#penentries').val(mytoken);
            $('.imagesrow').empty();
            var i = 1;
            while (mytoken >= i) {
              var url = "{{ url('storage/guidline_images') }}";
              $('.imagesrow').append('<div class="col-md-2" style="border:darkblue solid 1px;">\
<img src="' + url + '/' + realmytoken + '_I' + i + '.jpg" width="100%" />\
</div>');

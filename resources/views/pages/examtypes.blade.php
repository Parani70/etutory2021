...
<head>
  ...
  <title>E Tutory.lk | Exam Types</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Exam Types</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addexamtype')}}" class="col-sm-3 btn btn-block btn-primary">Add Exam Type</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <tbody>
                      ...
                      @foreach($dataset['examtypedata']->all() as $examtype)
                        <tr>
                          ...
                          <td>
                          <a href="{{url('/manageexamtype/'.$examtype->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif
    ...
    window.onload = function() {
      ...
      if (responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'New Exam Type : <b>' + responseMessege + '</b> saved successfully.'
        })
      }
      ...
      if (edit_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'Exam Type : <b>' + edit_responseMessege + '</b> updated successfully.'
        })
      }
      ...
      if (delete_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'Exam Type with ID: <b>' + delete_responseMessege + '</b> removed successfully.'
        })
      }
    }
  </script>

...
<body class="hold-transition login-page2 ">
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <img id="cardimage1" src="{{URL::asset('dist/img/Online learning-bro.png')}}" alt="" width="400px">
            <p class="p-img2">Currently we offer GCE O/L model papers in Sinhala and Tamil medium.
      ...
      <div class="col-md-6">
        <div class="card">
          <form action="{{url('/registerstudentsimp')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" class="form-control" placeholder="Reconfirm Password">
            ...
            <div class="card-footer">
              <div class="row">
                <div class="col-md-4"> <button type="submit" class="col-md-12 btn btn-primary-front btn-block">Register</button></div>
                <div class="col-md-6"> <a href="{{url('/')}}" class="col-md-6 btn btn-danger-front btn-block">Close</a></div>
              </div>

...
<head>
  ...
  <title>E Tutory.lk | Add New Pricing</title>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{url('/savepricing') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Exam Template</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control text-right" name="price" placeholder="Price">
                    </div>

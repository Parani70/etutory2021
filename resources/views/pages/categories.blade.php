...
<head>
  ...
  <title>E Tutory.lk | Categories</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addcategory')}}" class="col-md-2 btn btn-block btn-primary">Add Category</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <table id="master-datatable" class="table table-bordered">
                    ...
                    <tbody>
                      @if(count($dataset) > 0 )
                      @foreach($dataset['categoriesdata']->all() as $category)
                        <tr>
                          <td>{{$category->id}}</td>
                          <td>{{$category->gradename}}</td>
                          ...
                          <td>
                          <a href="{{url('/managecategory/'.$category->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif
    ...
    window.onload = function() {
      ...
      if (responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'New Category : <b>' + responseMessege + '</b> saved successfully.'
        })
      }
      ...
      if (edit_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'The Category : <b>' + edit_responseMessege + '</b> updated successfully.'
        })
      }
      ...
      if (delete_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'Category with ID: <b>' + delete_responseMessege + '</b> removed successfully.'
        })
      }
    }
  </script>

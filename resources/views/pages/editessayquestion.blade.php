...
<head>
  ...
  <title>E Tutory.lk | Edit Essay Question</title>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-default">
                ...
                <!-- /.card-header -->
                <form role="form" action="{{url('/updateessayquestion') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <textarea class="form-control textarea" rows="3" name="questionheader" placeholder="Enter Question">{{$dataset['questionmain'][0]->questionheader}}</textarea>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <img src="{{ url('storage/question_images/'.$dataset['questionmain'][0]->imageurl) }}" class="img-fluid" />
                      </div>
                    </div>
                    ...
                    <!-- /.row -->
                    @if($dataset['questionsub'][0]->imageupload == 'Y' & $dataset['questionsub'][0]->imageposition == 'before')
                    <div class="row">
                      <div class="col-md-8">
                        <img src="{{ url('/useruploaded/'.$dataset['questionsub'][0]->image) }}" class="img-fluid" />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <textarea class="form-control textarea" rows="3" name="answerguid" placeholder="Enter Correction Guidlines">{{$dataset['questionsub'][0]->crrectionguid}}</textarea>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    @if($dataset['questionsub'][0]->imageupload == 'Y' & $dataset['questionsub'][0]->imageposition == 'after')
                    <div class="row">
                      <div class="col-md-8">
                        <img src="{{ url('/useruploaded/'.$dataset['questionsub'][0]->image) }}" class="img-fluid" />
                      </div>

...
<head>
  ...
  <title>E Tutory.lk | promotionsmanager</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addpromotion')}}" class="col-sm-3 btn btn-block btn-primary">Add New Promotion</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                      <td style="width: 10px">{{$promotion->id}}</td>
                      <td>{{$promotion->promoname}}</td>
                      <td style="width: 40px">@if($promotion->status == 'A')
                        <span class="badge bg-success">Active</span>
                        @else
                        <span class="badge bg-secondary">Disabled</span>
                        @endif</td>
                      <td style="width: 40px"><a href="{{url('/managepromotion/'.$promotion->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a></td>

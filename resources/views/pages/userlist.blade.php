        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addnewuser')}}" class="col-sm-3 btn btn-block btn-primary">Add User</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    @if(count($dataset) > 0 )
                      @foreach($dataset['usersdata']->all() as $user)
                        <tr>
                          ...
                          <td>{{$user->role}}</td>
                          @if($user->status == 'A')
                          <td> <span class="float-right badge bg-success">Active</span></td>
                         
                          @else
                          <td><span class="float-right badge bg-danger">Disabled</span></td>
                          @endif
                         
                          <td>
                          <a href="{{url('/manageuser/'.$user->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif

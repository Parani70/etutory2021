...
<head>
  ...
  <title>E Tutory.lk | User Privileges</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">User Privilege Management</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addprivilege')}}" class="col-sm-3 btn btn-block btn-primary">Add User Privilege</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                    @if(count($dataset) > 0 )
                      @foreach($dataset['privilegesdata']->all() as $privileges)
                        <tr>
                          <td>{{$privileges->id}}</td>
                          <td>{{$privileges->privilege}}</td>
                          <td>{{$privileges->description}}</td>
                          <td>
                              @if($privileges->status == 'A')
                          ...
                          <td>
                          <a href="{{url('/manageprivilege/'.$privileges->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif

...
<head>
  ...
  <title>E Tutory.lk | On Hold</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" action="{{url('/filteronhold') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card-body">
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr class='clickable-row' data-href="{{url('/reviewquestion/2-'.$question->id)}}">
                        <td>{{$i}}</td>
                        ...
                        <td><a href="{{url('/reviewquestion/2-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">Edit</a></td>
                      </tr>

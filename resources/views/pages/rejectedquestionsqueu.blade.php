...
<head>
  ...
  <title>E Tutory.lk | Rejected</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" action="{{url('/filterreject') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card-body">
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr class='clickable-row2' data-href="{{url('/reviewquestion/'.$question->id)}}">
                        <td>{{$i}}</td>
                        ...
                        <td><a href="{{url('/reviewquestion/1-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">Edit</a></td>
                      </tr>

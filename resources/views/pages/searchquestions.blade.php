...
<head>
  ...
  <title>E Tutory.lk | Search Questions</title>
  ...
  <link rel="stylesheet" href="{{URL::asset('plugins/bootstrap-datepicker/css/bootstrap-datepicker.css')}}">
  <!-- summernote -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" action="{{url('/advancedsearchsubmit') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="card card-default">
                  <div class="card-header">
                    <h3 class="card-title">Search Questions</h3>
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="qstype" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="FILLBLANKS">FILL IN THE BLANCKS</option>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="enteredby" class="form-control select2" style="width: 100%;">

                            <option value="All">All</option>
                            @if(count($dataset['usersdata']) > 0)
                            @foreach($dataset['usersdata']->all() as $users)
                      ...
                      <div class="col-md-4"> 
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="enteredbydate" class="form-control float-right" id="datetimepicker1">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="approvedby" class="form-control select2" style="width: 100%;">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="approvedbydate" class="form-control float-right" id="datetimepicker2">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="questioncontain"class="form-control" placeholder="Question Contains">
                      </div>
                    </div>
                    <!-- /.row -->
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-block btn-info btn-sm col-sm-2">Search</button>
                  </div>
                  <!-- /.card-footer-->
                </div>
              </form>
                ...
                <div class="card-body">
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr class='clickable-row' data-href="{{url('/reviewquestion/'.$question->status.'-'.$question->id)}}">
                        <td>{{$i}}</td>
                        ...
                        <td><a href="{{url('/reviewquestion/'.$question->status.'-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">View</a></td>
                      </tr>

...
<head>
  ...
  <title>E Tutory.lk | Add Sub Category</title>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{url('/savesubcategory') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2"  name="parentcategory" id="parentcategory" style="width: 100%;">
                        @if(count($dataset) > 0)
                          @foreach($dataset['categoriesdata']->all() as $parentcategory)
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="subcategory" placeholder="Enter Sub Category" autofocus>
                    </div>
                  </div>
                  <!-- /.card-body -->

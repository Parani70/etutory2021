...
<head>
  ...
  <title>E Tutory.lk | Manage Category</title>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="{{url('/editcategory') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="grade" style="width: 100%;">
                        ...
                        @if($grade->id == $dataset['categorydata'][0]->gradeid)
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="subject" style="width: 100%;">
                        ...
                        @if($subject->id == $dataset['categorydata'][0]->subjectid)
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="category" value="{{$dataset['categorydata'][0]->category}}" placeholder="Enter Category">
                    </div>
                  </div>
                  <!-- /.card-body -->

                  <div class="card-footer">
                    <input type="hidden" id="categoryid" value="{{$dataset['categorydata'][0]->id}}" name="categoryid">
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="{{url('/removecategory/'.$dataset['categorydata'][0]->id)}}" class="btn btn-warning ">Remove Entry</a>

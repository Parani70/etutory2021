...
<head>
  ...
  <title>E Tutory.lk | For Approval</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" action="{{url('/filteredapprove') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="card-body">
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr class='clickable-row' data-href="{{url('/reviewquestion/1-'.$question->id)}}">
                        <td>{{$i}}</td>
                        ...
                        <!-- <td>{{substr($question->questionheader,0,36).'...'}}</td> -->
                        <td style="width: 50%; overflow: hidden; text-overflow: ellipsis;">{!!$question->questionheader!!}</td>
                        <td><a href="{{url('/reviewquestion/1-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">View</a></td>
                      </tr>

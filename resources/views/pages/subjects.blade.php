...
<head>
  ...
  <title>E Tutory.lk | Subjects</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addsubject ')}}" class="col-sm-3 btn btn-block btn-primary">Add Subject</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <tbody>
                      ...
                      @foreach($dataset['subjectsdata']->all() as $subject)
                        <tr>
                          ...
                          <td>
                          <a href="{{url('/managesubject/'.$subject->id)}}" class="btn btn-block btn-outline-info btn-xs">Edit</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif
    ...
    window.onload = function() {
      ...
      if (responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'New Subject : <b>' + responseMessege + '</b> saved successfully.'
        })
      }
      ...
      if (edit_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'The Subject : <b>' + edit_responseMessege + '</b> updated successfully.'
        })
      }
      ...
      if (delete_responseMessege != '') {
        $(document).Toasts('create', {
          ...
          body: 'Subject with ID: <b>' + delete_responseMessege + '</b> removed successfully.'
        })
      }
    }
  </script>

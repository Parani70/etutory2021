...
<head>
  ...
  <title>E Tutory.lk | User Roles</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-body">
                  <a href="{{url('/addrole')}}" class="col-sm-3 btn btn-block btn-primary">Add User Role</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                    @if(count($dataset) > 0 )
                      @foreach($dataset['userrolesdata']->all() as $userrole)
                        <tr>
                          <td>{{$userrole->id}}</td>
                          <td>{{$userrole->userrole}}</td>
                          <td>{{$userrole->privileges}}</td>
                          <td>
                          ...
                          <td>
                          <a href="{{url('/managerole/'.$userrole->id)}}" class="btn btn-block btn-outline-info btn-xs">Manage</a>
                          </td>
                        </tr>
                      @endforeach
                      @endif

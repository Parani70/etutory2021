...
<head>
  ...
  <title>E Tutory.lk |  Succesfull</title>
    ...
    <section id="about" class="about">
      <div class="container" style="margin-top: 30px;">
        ...
        <div class="section-title">
          ...
          <h3><span>Password Reset Email Sent!</span></h3>
        ...
        <div class="row content">
          ...
          <div class="col-lg-12 pt-4 pt-lg-0">
            <p>
              Please click on the link and proceesd to change the password
            </p>
            <p>
              Please login to continue.
            </p>
            <a href="{{url('/loginpage')}}" class="btn-learn-more">Login</a>
          </div>
        </div>

...
<head>
  ...
  <title>E Tutory.lk | Dashboard</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" action="{{url('/filterdash_tobe') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <table id="questions-datatable" class="table">
                    ...
                    <tbody>
                      ...
                      <tr class='clickable-row2' data-href="{{url('/entermcqquestion')}}">
                        <td>{{$i}}</td>
                        ...
                        <td><a href="{{url('/editquestion/3-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">Edit</a></td>
                      </tr>
                ...
                <div class="card-footer">
                  <a href="{{url('/savedquestionsqueu')}}" class="col-md-2 btn btn-block btn-info btn-sm">Show All</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <table id="questions-datatable2" class="table">
                    <thead>
                      <tr>
                        <th style="width: 10px">#</th>
                        <th>Exam Type</th>
                    ...
                    <tbody>
                      ...
                      @if(count($dataset['questiondata_rejected'] )> 0)
                      @php
                      $i=1;
                      @endphp
                      @foreach($dataset['questiondata_rejected']->all() as $question)
                      ...
                      <tr class='clickable-row2' data-href="{{url('/entermcqquestion')}}">
                        ...
                        <td>{{$question->qstype}}</td>
                        <td>{{$question->questionheader}}</td>
                        <td><a href="{{url('/editquestion/4-'.$question->id)}}" class="btn btn-block btn-secondary btn-sm">Edit</a></td>
                      </tr>
                ...
                <div class="card-footer">
                  <a href="{{url('/rejectedquestionsqueu')}}" class="col-md-2 btn btn-block btn-info btn-sm">Show All</a>
                </div>
              </div>
            </div>
          </div>

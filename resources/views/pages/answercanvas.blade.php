...
<head>
  ...
  <title>E Tutory.lk | Answer Canvas</title>
...
body {
    ...
    .paint-canvas {
      ...
      display: block;
      margin: 1rem;
      cursor: url('../dist/img/pen.png') 0 34, auto;
    }
...
<body class="hold-transition ">
    ...
    <div class="content-wrapper2">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <input type="hidden" id="essayentryidval" value="{{ $dataset['examseatid'] }}" name="essayentryidval">
          <input type="hidden" id="examseatid" value="{{ $dataset['examseatid'] }}" name="examseatid">
          <input type="hidden" id="questtionid" value="{{ $dataset['questionid'] }}" name="questtionid">
  ...
  <script>
    ...
    $('#done').click(function(){
      ...
      var questionid = $('#questtionid').val();
      ...
      $.ajax({
        ...
        url: "/doneanswercanvas",
        data: {
          _token: "{{ csrf_token() }}",
          slidercountval: entriescount,
          entrytocken: entrytocken,
    ...
    $('#save').click(function() {
      ...
      $.ajax({
        ...
        console.log(''+o);
        var onlyImageName = o.substring(20);
        console.log(onlyImageName);

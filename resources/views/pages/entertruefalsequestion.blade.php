...
<head>
  ...
  <title>E Tutory.lk | Enter True/False Question</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Enter Question | True/False</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-default">
                ...
                <!-- /.card-header -->
                <form role="form" action="{{url('/savetruefalsequestion') }}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="trueflase-anser-block">
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input type="text" class="form-control" name="q1" placeholder="Enter Question 1">
                            @error('q1')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <select class="form-control select2" name="qoption1" style="width: 100%;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input type="text" class="form-control" name="q2" placeholder="Enter Question 2">
                            @error('q2')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <select class="form-control select2" name="qoption2" style="width: 100%;">
                              <option value="True">True</option>
                              <option value="False">False</option>
                            </select>
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input type="text" class="form-control" name="q3" placeholder="Enter Question 3">
                            @error('q3')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <select class="form-control select2" name="qoption3" style="width: 100%;">
                              <option value="True">True</option>
                              <option value="False">False</option>
                            </select>
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input type="text" class="form-control" name="q4" placeholder="Enter Question 4">
                            @error('q4')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <select class="form-control select2" name="qoption4" style="width: 100%;">
                              <option value="True">True</option>
                              <option value="False">False</option>
                            </select>
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input type="text" class="form-control" name="q5" placeholder="Enter Question 5">
                            @error('q5')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <select class="form-control select2" name="qoption5" style="width: 100%;">
                              <option value="True">True</option>
                              <option value="False">False</option>
                            </select>
                          </div>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{url('/entertruefalsequestion')}}" class="btn btn-secondary ">Clear</a>
...
$(function () {
    ...
    $('#addquestion').click(function() {
      ...
      $('#questionsblock').append('<div class="row">\
                        ...
                        <div class="col-md-9">\
                          <div class="form-group">\
                            <input type="text" class="form-control" name="q' + questionscount + '" placeholder="Enter Question ' + questionscount + '">\
                          </div>\
                        </div>\
                        <div class="col-md-2">\
                          <div class="form-group">\
